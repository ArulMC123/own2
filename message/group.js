...
module.exports = welcome = async (Ramdani, anu) => {
		...
		try {
            ...
            Ramdani.sendMessage(anu.jid, 'Halo! Udh Izin Owner Gw Belum ???, Kalo Belum Gw Leave !!!', 'conversation')
            }
             if (anu.action == 'add' && !mem.includes(Ramdani.user.jid)) {
             if (!welkom.includes(anu.jid)) return
                ...
                buttonsMessage = { contentText: `${teks}`, footerText: 'Baca deskripsi dulu Bang Jangan Asal Masuk Ntr Di Kick !!', imageMessage: imageMsg, buttons: buttons, headerType: 4 }
